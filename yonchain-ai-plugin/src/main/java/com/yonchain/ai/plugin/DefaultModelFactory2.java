...
@Component
public class DefaultModelFactory2 implements ModelFactory {

    private static final Logger logger = LoggerFactory.getLogger(DefaultModelFactory2.class);

    private final Map<String, ModelProvider> providers = new ConcurrentHashMap<>();

    public DefaultModelFactory2(List<ModelProvider> providerList) {
        // 注册所有可用的模型提供商
