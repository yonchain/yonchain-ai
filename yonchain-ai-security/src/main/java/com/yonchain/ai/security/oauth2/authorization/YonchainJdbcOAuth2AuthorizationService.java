...
import com.yonchain.ai.security.oauth2.authorization.jackson2.YonchainOAuth2AuthorizationServerJackson2Module;
 ...
 * @author Cgy
 */
@ImportRuntimeHints(YonchainJdbcOAuth2AuthorizationService.JdbcOAuth2AuthorizationServiceRuntimeHintsRegistrar.class)
public class YonchainJdbcOAuth2AuthorizationService implements OAuth2AuthorizationService {
     ...
     */
    public YonchainJdbcOAuth2AuthorizationService(JdbcOperations jdbcOperations,
    ...
    public static class OAuth2AuthorizationRowMapper implements RowMapper<OAuth2Authorization> {
        ...
        public OAuth2AuthorizationRowMapper(RegisteredClientRepository registeredClientRepository) {
            ...
            ClassLoader classLoader = YonchainJdbcOAuth2AuthorizationService.class.getClassLoader();
            List<Module> securityModules = SecurityJackson2Modules.getModules(classLoader);
            this.objectMapper.registerModules(securityModules);
            this.objectMapper.registerModule(new OAuth2AuthorizationServerJackson2Module());
            this.objectMapper.registerModule(new YonchainOAuth2AuthorizationServerJackson2Module());
        }
