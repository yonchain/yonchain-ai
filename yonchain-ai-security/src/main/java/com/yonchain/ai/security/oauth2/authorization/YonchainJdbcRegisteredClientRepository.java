 ...
 *      1.表名由oauth2_registered_client改为oauth2_registered_client</br>
 ...
 * @since 1.0.0
 */
@ImportRuntimeHints(YonchainJdbcRegisteredClientRepository.Difj4jJdbcRegisteredClientRepositoryRuntimeHintsRegistrar.class)
public class YonchainJdbcRegisteredClientRepository implements RegisteredClientRepository {
     ...
     */
    public YonchainJdbcRegisteredClientRepository(JdbcOperations jdbcOperations) {
    ...
    public static class RegisteredClientRowMapper implements RowMapper<RegisteredClient> {
        ...
        public RegisteredClientRowMapper() {
            ClassLoader classLoader = YonchainJdbcRegisteredClientRepository.class.getClassLoader();
