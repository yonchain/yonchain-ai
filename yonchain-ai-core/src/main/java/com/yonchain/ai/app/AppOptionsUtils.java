...
import com.yonchain.ai.util.JacksonUtils;
...
/**
 * Utility class for manipulating {@link AppOptions} objects.
 *
 * @author Cgy
 * @since 0.1.0
 */
public abstract class AppOptionsUtils {
    ...
    public static <T> T merge(Object source, Object target, Class<T> clazz, List<String> acceptedFieldNames) {
        ...
        List<String> requestFieldNames = CollectionUtils.isEmpty(acceptedFieldNames)
                ? REQUEST_FIELD_NAMES_PER_CLASS.computeIfAbsent(clazz, AppOptionsUtils::getJsonPropertyValues)
                : acceptedFieldNames;
        ...
        Map<String, Object> sourceMap = AppOptionsUtils.objectToMap(source);
        Map<String, Object> targetMap = AppOptionsUtils.objectToMap(target);
        ...
        return AppOptionsUtils.mapToClass(targetMap, clazz);
    }
    ...
    public static <T> T merge(Object source, Object target, Class<T> clazz) {
        return AppOptionsUtils.merge(source, target, clazz, null);
    }
    ...
    public static <I, S extends I, T extends S> T copyToTarget(S sourceBean, Class<I> sourceInterfaceClazz,
        ...
        try {
            ...
            AppOptionsUtils.mergeBeans(sourceBean, targetOptions, sourceInterfaceClazz, true);
