...
/**
 * Some app providers API leverage short-lived api keys which must be renewed at regular
 ...
 * to the app provider. Implementations of this interface can cache the api key and
